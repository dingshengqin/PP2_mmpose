...
data_root = 'mmdetection/data/coco-person-limited/'  
...
load_from = 'mmdection/checkpoint/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth'
...
# Evaluator 测试集上的评估指标
# val_evaluator = dict(type='CocoMetric',ann_file=data_root + 'person_keypoints_val2017.json',metric='bbox',format_only=False, backend_args=backend_args)
# val_evaluator = dict(type='VOCMetric', metric='mAP', eval_mode='11points')

val_evaluator = [
    dict(type='CocoMetric',ann_file=data_root + 'valid_annotations.coco.json',metric='bbox',format_only=False, backend_args=backend_args), 
